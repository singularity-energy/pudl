...
def _identify_entirely_transitioned_plants(
    ...
    * none of those generators' ``transition_date_col`` falls within the report_year,
    ...
    # can't rule out an anomaly -- most genuinely-still-proposed generators have no
    # recorded generator_operating_date at all, since it isn't populated until they
    # actually start operating -- so treat a null transition date as anomalous too.
